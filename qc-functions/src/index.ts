...
apiRouter.post("/projects/:projectId/upload-logo", async (req: Request, res: Response): Promise<Response> => {
  ...
  try {
    ...
    const bucket = getStorage().bucket(CORRECT_BUCKET_NAME); // (ใช้ชื่อที่ถูกต้อง)
